...
public class DictAspect {
    ...
    private static Logger log = LoggerFactory.getLogger(DictAspect.class);
...
//        }
    ...
    private void getNodePath(Object object, String startPath, List<String> paths, Class target) throws IllegalAccessException {
        ...
        if (object != null)
            for (Field declaredField : object.getClass().getDeclaredFields()) {
                ...
                if (declaredField.getType().equals(Object.class)) {
                    ...
                    if(o!=null){
                        if (o!=null && o.getClass().equals(target)) {
                            paths.add("/" + declaredField.getName());
    ...
    private Object jacksonResponseDictFilterHandler(JoinPoint joinPoint, Class clazz/*, List<DictFilter> dictResponseFilters*/, Object result) throws IOException, IllegalAccessException {
        ...
        if (result instanceof MessageResponse) {
            ...
            if (paths.size() == 0) paths.add("/data");
...
//            System.out.println(objectMapper.writeValueAsString(result));
            ...
            for (String path : paths) {
                ...
                if (at != null) {
                    ...
                    //解析对象
                    if (at.isObject()) {
                        setDictData((ObjectNode) at, dictFilterMap, dictFilterTypeMap);
                    }
                }
            }
